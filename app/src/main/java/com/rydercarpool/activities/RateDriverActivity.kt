...
class RateDriverActivity : AppCompatActivity() {
    ...
    private fun getIntentData() {
        driverName = intent.getStringExtra("driver_name") ?: "Driver"
        rideId = intent.getStringExtra("ride_id") ?: ""

        // Set driver name in UI
        findViewById<TextView>(R.id.tvUserName).text = driverName
        findViewById<TextView>(R.id.tvUserType).text = "Driver"
    }
    ...
    private fun submitRating() {
        ...
        val intent = Intent(this, RideCompletionActivity::class.java)
